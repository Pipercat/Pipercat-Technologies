...
const CATALOG = Object.freeze([
  ...
  { integration: 'govee', manufacturer: 'Govee', category: 'lan', profiles: ['light'], level: 'experimental', localOnly: true, pilot: true, evidence: 'H6008/H605C-Adapter und Fehlerfälle simulationsbasiert getestet', limitations: ['Realer LAN-Hardwaretest ausstehend', 'Nur Modelle mit sichtbarer LAN-Control-Option', 'Keine Govee OpenAPI oder Cloud'] },
